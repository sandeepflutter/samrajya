                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.fromLTRB(5, 10, 5, 8.0),
                            child: Text(
                              snapshot.data.documents[I]['productName'],textAlign: TextAlign.justify,
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: RichText(
                                text: TextSpan(
                                  text: 'Rs. ',
                                  style: TextStyle(fontWeight: FontWeight.bold,color: Colors.lightGreen,fontSize: 35),
                                  children: <TextSpan>[
                                    TextSpan(text: snapshot.data.documents[I]['price'], style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 35),),
                                  ],
                                ),
                              ),
                            ),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: RichText(
                                text: TextSpan(text: snapshot.data.documents[I]['description'], style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 25),),
                              ),
                            ),
                          ),
Divider(),
